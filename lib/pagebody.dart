    ...
    children: [
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                teamStat("Away Team", allmatches[0].away.logoUrl, allmatches[0].away.name),
      ...
      Expanded(
        ...
        child: Container( 
          ...
          decoration: BoxDecoration(color: Color(0xFF4373D9), borderRadius: BorderRadius.only(topLeft: Radius.circular(40.0), topRight: Radius.circular(40.0))),
          child: Padding(
            ...
            child: Column(
              ...
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                Text("MATCHES", style: TextStyle(color: Colors.white, fontSize: 24.0),),
                Expanded(
